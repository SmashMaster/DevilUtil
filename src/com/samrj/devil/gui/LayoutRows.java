 ...
 */
public class LayoutRows extends FormColorable implements LayoutAligned<LayoutRows>
{
    ...
    public LayoutRows(Align defaultAlignment)
    {
    ...
    public LayoutRows add(Form form, Align alignment)
    {
